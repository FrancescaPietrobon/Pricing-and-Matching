    ...
    def add_customer_data(self, customer_data):
        ...
        if customer_data.is_second_purchase():
            if customer_data.get_group() == 1:
                self.purchases_item2[0] += 1
            elif customer_data.get_group() == 2:
                self.purchases_item2[1] += 1
            elif customer_data.get_group() == 3:
                self.purchases_item2[2] += 1
            elif customer_data.get_group() == 4:
                self.purchases_item2[3] += 1
        if customer_data.is_first_purchase():
            if customer_data.get_group() == 1:
                self.customers_purchases[0] += 1
                if customer_data.is_first_promo():
                    if customer_data.is_second_purchase():
                        self.purchases_item21[0][0] += 1
                    else:
                        self.purchases_item1[0][0] += 1
                elif customer_data.is_second_promo():
                    if customer_data.is_second_purchase():
                        self.purchases_item21[1][0] += 1
                    else:
                        self.purchases_item1[1][0] += 1
                elif customer_data.is_third_promo():
                    if customer_data.is_second_purchase():
                        self.purchases_item21[2][0] += 1
                    else:
                        self.purchases_item1[2][0] += 1
                elif customer_data.is_fourth_promo():
                    if customer_data.is_second_purchase():
                        self.purchases_item21[3][0] += 1
                    else:
                        self.purchases_item1[3][0] += 1


            elif customer_data.get_group() == 2:
                self.customers_purchases[1] += 1
                if customer_data.is_first_promo():
                    if customer_data.is_second_purchase():
                        self.purchases_item21[0][1] += 1
                    else:
                        self.purchases_item1[0][1] += 1
                elif customer_data.is_second_promo():
                    if customer_data.is_second_purchase():
                        self.purchases_item21[1][1] += 1
                    else:
                        self.purchases_item1[1][1] += 1
                elif customer_data.is_third_promo():
                    if customer_data.is_second_purchase():
                        self.purchases_item21[2][1] += 1
                    else:
                        self.purchases_item1[2][1] += 1
                elif customer_data.is_fourth_promo():
                    if customer_data.is_second_purchase():
                        self.purchases_item21[3][1] += 1
                    else:
                        self.purchases_item1[3][1] += 1

            elif customer_data.get_group() == 3:
                self.customers_purchases[2] += 1
                if customer_data.is_first_promo():
                    if customer_data.is_second_purchase():
                        self.purchases_item21[0][2] += 1
                    else:
                        self.purchases_item1[0][2] += 1
                elif customer_data.is_second_promo():
                    if customer_data.is_second_purchase():
                        self.purchases_item21[1][2] += 1
                    else:
                        self.purchases_item1[1][2] += 1
                elif customer_data.is_third_promo():
                    if customer_data.is_second_purchase():
                        self.purchases_item21[2][2] += 1
                    else:
                        self.purchases_item1[2][2] += 1
                elif customer_data.is_fourth_promo():
                    if customer_data.is_second_purchase():
                        self.purchases_item21[3][2] += 1
                    else:
                        self.purchases_item1[3][2] += 1

            elif customer_data.get_group() == 4:
                self.customers_purchases[3] += 1
                if customer_data.is_first_promo():
                    if customer_data.is_second_purchase():
                        self.purchases_item21[0][3] += 1
                    else:
                        self.purchases_item1[0][3] += 1
                elif customer_data.is_second_promo():
                    if customer_data.is_second_purchase():
                        self.purchases_item21[1][3] += 1
                    else:
                        self.purchases_item1[1][3] += 1
                elif customer_data.is_third_promo():
                    if customer_data.is_second_purchase():
                        self.purchases_item21[2][3] += 1
                    else:
                        self.purchases_item1[2][3] += 1
                elif customer_data.is_fourth_promo():
                    if customer_data.is_second_purchase():
                        self.purchases_item21[3][3] += 1
                    else:
                        self.purchases_item1[3][3] += 1
