class Group:
    def __init__(self, number, conversion_rate_item1=0.5, conversion_rate_item2=0.5, conversion_rate_item2_given_item1_P0=0.5,
                 conversion_rate_item2_given_item1_P1=0.5, conversion_rate_item2_given_item1_P2=0.5, conversion_rate_item2_given_item1_P3=0.5):
        self.number = number
